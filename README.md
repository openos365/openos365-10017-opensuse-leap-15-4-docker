...
docker run -it openos365/openos365-10017-opensuse-leap-15-4-docker-main-root:latest bash
```
#### www

```
docker pull openos365/openos365-10017-opensuse-leap-15-4-docker-main-www:latest
docker run -it openos365/openos365-10017-opensuse-leap-15-4-docker-main-www:latest bash
```
